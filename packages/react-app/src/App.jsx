...
import mainnetNftContracts from "./abi's/mainnetNFT.json";
...
const deployedContracts = { ...hardhatContracts, ...mainnetNftContracts };
  ...
  return (
    <div className="App">
      ...
      {/* <Switch>
        ...
        <Route exact path="/">
          <Home address={address} localProvider={localProvider} readContracts={readContracts} />
        </Route>
